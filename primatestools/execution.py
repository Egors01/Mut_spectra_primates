...
from primatestools.plotting import plot_mutational_spectra, plot_heatmaps
...
for i,name in enumerate(['pantro_sample.bed','pantro_sample2.bed']):
    ...
    m96_dfs[sp_name] = mstools.reduce_192_to_96_kelley_notation(m192=m192_dfs[sp_name])
print()
...
plot_heatmaps(m96=m96,sp_plotname_to_col_name=sp_dict,pictures_sets_list=setlist,title='test')
